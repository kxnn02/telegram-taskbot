...
/**
 * Send a submitted task back for revision (Phase 6.2, issue #17 — REST
 * mutation, per ADR-0008). No request body. All rules (must be Submitted,
 * higher-up-only, etc.) live in and are enforced by `TaskService.reviseTask`.
 */
